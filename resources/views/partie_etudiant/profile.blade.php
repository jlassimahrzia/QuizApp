...
<div class="row">
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 bg-white border-radius-4 box-shadow">
            ...
            <p class="text-center text-muted">Etudiant</p>
            ...
            <div class="profile-tab height-100-p">
                <div class="tab height-100-p">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tasks" role="tab">Historique</a>
                        </li>
                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-desc bg-white border-radius-4 box-shadow">
                                                <div class="pd-20">
                                                    <div class="task-name">
                                                        {{$resultat->qcm->niveau->matiere->nom}} <i class="icon-copy fa fa-arrow-right" aria-hidden="true"></i>
                                                        {{$resultat->qcm->niveau->nom}} <i class="icon-copy fa fa-arrow-right" aria-hidden="true"></i>
                                                        {{$resultat->qcm->nom}}
                                                    </div>
                                                    @if($resultat->is_succeeded == '1')
                                                    <p style="color: green">{{$resultat->pourcentage}}% vous avez réussi ce qcm</p>
                                                    @endif
                                                    @if($resultat->is_succeeded == '0')
                                                    <p style="color: red">{{$resultat->pourcentage}}% vous avez échoué dans ce qcm</p>
                                                    @endif
                                                    <a class="card-link text-primary" href="{{ route('qcm' ,$resultat->qcm->id )}}">
